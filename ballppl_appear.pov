...
object{ball
        scale 0.25
        scale y*sin(40+40*(clock-1))+2
        translate <0, 0, 25>}
object{ball
        scale 0.5              
        scale y*sin(50+50*(clock-1))+2
        translate <-5, 0, 24>}   
object{ball
        scale 0.3     
        scale y*sin(20+20*(clock-1))+2
        translate <5, 0, 24>} 
object{ball
        scale 0.2 
        scale y*sin(30+30*(clock-1))+2
        translate <15, 0, 20>}    
object{ball
        scale 0.7  
        scale y*sin(80+80*(clock-1))+2
        translate <-15, 0, 20>}                           
object{ball
        scale 0.25  
        scale y*sin(20+20*(clock-1))+2
